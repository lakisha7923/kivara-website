...
const tabs = [
  { href: "/facility", label: "Home", icon: "🏠", exact: true },
  { href: "/facility/requests", label: "Requests", icon: "📋" },
  { href: "/facility/attendance", label: "Live", icon: "⏱" },
  { href: "/facility/assignments", label: "Staff", icon: "✓" },
  { href: "/facility/timesheets", label: "Hours", icon: "▤" },
  { href: "/facility/more", label: "More", icon: "•••" },
];
...
export default function FacilityShell({
  ...
  children: ReactNode;
  /** Optional page label kept for older screens; header already brands the app. */
  title?: string;
}) {
  ...
  return (
    <div className="mx-auto flex min-h-[100dvh] w-full max-w-md flex-col bg-[var(--kivara-offwhite)] text-[var(--kivara-navy)] shadow-xl md:border-x md:border-slate-200">
      <header className="sticky top-0 z-40 bg-[var(--kivara-navy)] px-3 py-2 text-white safe-pt sm:px-4 sm:py-3">
          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-[10px] font-medium text-[var(--kivara-aqua)]">
                {title ? `${title} · Facility` : "Facility Mobile App"}
              </p>
            </div>
          </div>
        ...
        <div className="mt-2 truncate rounded-full bg-white/10 px-3 py-1 text-[11px] font-semibold text-white/90">
      ...
      <nav
        ...
        aria-label="Facility primary navigation"
      >
